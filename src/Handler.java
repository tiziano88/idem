...
public class Handler {
    ...
    public Handler(@NotNull CompletionType completionType) {
        this(completionType, true, false, true);
    }

    public Handler(@NotNull CompletionType completionType, boolean invokedExplicitly, boolean autopopup, boolean synchronous) {
    ...
    */
    ...
    private static AutoCompletionPolicy getAutocompletionPolicy(LookupElement element) {
        return AutoCompletionPolicy.getPolicy(element);
    }
